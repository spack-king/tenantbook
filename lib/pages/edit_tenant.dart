...
class EditTenant extends StatefulWidget {
  final index;
  const EditTenant({super.key, required this.index});
...
// TODO: Add _rewardedAd
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Update Tenant\'s details'),
      ),
      body: SafeArea(
  ...
  void addHouse() {
    if(img == ''){
      ...
      var id = '${box.getAt(widget.index)!.id}';
      ...
      showSpackSnackBar('Successfully updated!', context, Colors.green, Icons.done_outline);
  ...
  void getUserDetails() {
    ...
    img = '${box.getAt(widget.index)!.profPics}';
    nameEditingController.text = '${box.getAt(widget.index)!.tenant_name}';
    occupationEditingController.text = '${box.getAt(widget.index)!.occupation}';
    flatEditingController.text = '${box.getAt(widget.index)!.flat}';
    phonNOEditingController.text = '${box.getAt(widget.index)!.phoneNo}';
    rentAmountEditingController.text = '${box.getAt(widget.index)!.rentAmount}';
    rentDueEditingController.text = '${box.getAt(widget.index)!.lastPayment}';
  }
}
